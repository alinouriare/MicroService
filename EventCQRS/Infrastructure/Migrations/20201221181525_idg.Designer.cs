            ...
            modelBuilder.Entity("Domain.Models.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 4,
                            Body = "body",
                            CreateAt = new DateTime(2020, 12, 21, 21, 45, 23, 364, DateTimeKind.Local).AddTicks(6318),
                            FilePath = "File",
                            ImagePath = "Image",
                            IsDeleted = false,
                            IsSallable = true,
            ...
            modelBuilder.Entity("Domain.Models.Users.CustomIdentityUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BrithDate = new DateTimeOffset(new DateTime(2020, 12, 21, 21, 45, 23, 377, DateTimeKind.Unspecified).AddTicks(699), new TimeSpan(0, 3, 30, 0, 0)),
                            CreateAt = new DateTime(2020, 12, 21, 21, 45, 23, 376, DateTimeKind.Local).AddTicks(5618),
                            FirstName = "ali",
                            IsActive = true,
                            IsEmailPublic = true,
                            LastName = "nouri",
                            LastVisitDateTime = new DateTimeOffset(new DateTime(2020, 12, 21, 21, 45, 23, 377, DateTimeKind.Unspecified).AddTicks(7827), new TimeSpan(0, 3, 30, 0, 0)),
                            Location = "",
                            LoginCount = 1,
                            Mobile = 0L,
                            PhotoFileName = "",
